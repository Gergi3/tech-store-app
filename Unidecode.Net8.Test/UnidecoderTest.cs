...
public class UnidecoderTest
{
	...
	public void RussianAlphabetTest()
	{
		...
		string expectedLowercase = "a b v g d e yo zh z i y k l m n o p r s t u f kh ts ch sh sht \" y ' e yu ya";
		string expectedUppercase = "A B V G D E Yo Zh Z I Y K L M N O P R S T U F Kh Ts Ch Sh Sht \" Y ' E Yu Ya";
	...
	public void CharUnidecodeTest()
	{
		...
		string expected = "a b v g d e yo zh z i y k l m n o p r s t u f kh ts ch sh sht \" y ' e yu ya A B V G D E Yo Zh Z I Y K L M N O P R S T U F Kh Ts Ch Sh Sht \" Y ' E Yu Ya";
